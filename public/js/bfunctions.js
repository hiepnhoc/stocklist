 ...
 * COOKIE, SEARCH, FAVORITE, HOVER, LOCATION
 */
/* $VERSION: 1.1 */

var ReleaseCompany="ACBS";
var LabelDisplayRoom="DisplayRoom_" + ReleaseCompany;
var LabelaSLCKName="AllSL_" + ReleaseCompany;
var LabelfSLCKName="FavoriteSL_" + ReleaseCompany;
...
/******************************************************************************
   NAME:    HOVER
   PURPOSE: Change background color when hover mouse
******************************************************************************/
function RowMouseOver(elm){
	elm.className += " bghover";   
}
function RowMouseOut(elm){
	elm.className = elm.className.replace(/bghover/,'');
}
