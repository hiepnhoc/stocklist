...
function Stock({item}){
    ...
    const {FIELD_DEF} = useSelector((state)=>state.todos);
    console.log('Item stock: item.CODE',item.CODE);
    useEffect(()=>{        
        const subscription = new Subscription("MERGE",item.CODE,FIELD_DEF.map(function(field){
            return field;
        }));
    ...
    return( //isState className="al icon-chart icon-close" className={`addstoke${isCheckIcon ? "show": ""}`}
    <tr className={`icon-chart${isCheckIcon? "":"show"}`}  id={item} data-source="lightstreamer" >
    <td  id="onhoverck" >
        <span  data-source='lightstreamer' data-field='CODE' className="bghovertext tootipck ff fB fl" style={{cursor: 'pointer',color:activeStyle['CODE'] }} title="" >{item.CODE}</span>  
        <span className="bghovertext tootipck ff fB fl"><i class="fa fa-plus" aria-hidden="true" ></i></span>   
            <div className="clear"></div>
    </td>
    <td data-source='lightstreamer' data-field='CEILING_PRICE' style={{backgroundColor: 'linear-gradient(to right, red 50%, blue 50%)', color:activeStyle['CEILING_PRICE']}} className="Bgline dln800 c">{state['CEILING_PRICE']}</td>
    <td data-source='lightstreamer' data-field='FLOOR_PRICE' style={{color:activeStyle['FLOOR_PRICE']}} className="Bgline bg-bdl dln800 f">{state['FLOOR_PRICE']}</td>
    <td data-source='lightstreamer' data-field='BASIC_PRICE' style={{color:activeStyle['BASIC_PRICE']}} className="Bgline bg-bdl dln800 n">{state['BASIC_PRICE']}</td>
    <td className="dln640" data-source='lightstreamer' style={{color:activeStyle['BPRICE3']}} data-field='BPRICE3' >{state['BPRICE3']}</td>
    <td className="dln640" data-source='lightstreamer' style={{color:activeStyle['BQTTY3']}} data-field='BQTTY3'>{state['BQTTY3']}</td>
    <td className="dln500" data-source='lightstreamer' style={{color:activeStyle['BPRICE2']}} data-field='BPRICE2'>{state['BPRICE2']}</td>
    <td className="dln500" data-source='lightstreamer' style={{color:activeStyle['BQTTY2']}} data-field='BQTTY2'>{state['BQTTY2']}</td>
    <td data-source='lightstreamer' data-field='BPRICE1' style={{color:activeStyle['BPRICE1']}}>{state['BPRICE1']}</td>
    <td data-source='lightstreamer' data-field='BQTTY1' style={{color:activeStyle['BQTTY1']}}>{state['BQTTY1']}</td>
    <td className="Bgline showrownameck dlnshowrownameck">
        <span onMouseOver={()=>getStockName({item})} data-source='lightstreamer' data-field={item} className="tootipck ff fB fl" onClick={()=>showStockChart({item})} style={{cursor: 'pointer'}} title=""></span>  
        
    </td>
    <td className="Bgline" data-source='lightstreamer' data-field='MATCH_PRICE' style={{color:activeStyle['MATCH_PRICE']}}>{state['MATCH_PRICE']}</td>
    <td className={"Bgline"} data-source='lightstreamer' data-field='MATCH_QTTY' style={{color:activeStyle['MATCH_PRICE']}}>{state['MATCH_QTTY']}</td>
    <td className="Bgline">	
        <span data-source='lightstreamer' data-field='CHANGE' className="match" style={{color:activeStyle['CHANGE']}}>{state['CHANGE']}</span>
        <span data-source='lightstreamer' data-field='p' className="present" style={{display: 'none'}}></span>
    </td>
    <td className="" data-source='lightstreamer' data-field='SPRICE1' style={{color:activeStyle['SPRICE1']}}>{state['SPRICE1']}</td>
    <td className="" data-source='lightstreamer' data-field='SQTTY1' style={{color:activeStyle['SQTTY1']}}>{state['SQTTY1']}</td>
    <td className="dln500" data-source='lightstreamer' data-field='SPRICE2' style={{color:activeStyle['SPRICE2']}}>{state['SPRICE2']}</td>
    <td className="dln500" data-source='lightstreamer' data-field='SQTTY2' style={{color:activeStyle['SQTTY2']}}>{state['SQTTY2']}</td>
    <td className="dln640" data-source='lightstreamer' data-field='SPRICE3' style={{color:activeStyle['SPRICE3']}}>{state['SPRICE3']}</td>
    <td className="dln640" data-source='lightstreamer' data-field='SQTTY3' style={{color:activeStyle['SQTTY3']}}>{state['SQTTY3']}</td>
    <td className="dln800" >
        <span  className="tbodytotalkl" data-source='lightstreamer' data-field='TOTAL_TRADED_QTTY' style={{color:activeStyle['TOTAL_TRADED_QTTY']}}>{state['TOTAL_TRADED_QTTY']}</span>
        <span  className="tbodytotalgt" data-source='lightstreamer' data-field='TOTAL_TRADED_VALUE' style={{color:activeStyle['TOTAL_TRADED_VALUE']}}>{state['TOTAL_TRADED_VALUE']}</span>
    </td> 
    <td className="Bgline dln900" data-source='lightstreamer' data-field='AVERAGE_PRICE' style={{color:activeStyle['AVERAGE_PRICE']}}>{state['AVERAGE_PRICE']}</td>
    <td className="Bgline dln900" data-source='lightstreamer' data-field='HIGHEST_PRICE' style={{color:activeStyle['HIGHEST_PRICE']}}>{state['HIGHEST_PRICE']}</td>
    <td className="Bgline dln900" data-source='lightstreamer' data-field='LOWEST_PRICE' style={{color:activeStyle['LOWEST_PRICE']}}>{state['LOWEST_PRICE']}</td>
    <td className="changerow dln970" data-source='lightstreamer' data-field='BUY_FOREIGN_QTTY' style={{color:activeStyle['BUY_FOREIGN_QTTY']}}>{state['BUY_FOREIGN_QTTY']}</td>
    <td className="changerow dln970" data-source='lightstreamer' data-field='SELL_FOREIGN_QTTY' style={{color:activeStyle['SELL_FOREIGN_QTTY']}}>{state['SELL_FOREIGN_QTTY']}</td> 
    <td className="changerow1" data-source='lightstreamer' data-field='CURRENT_ROOM' style={{color:activeStyle['CURRENT_ROOM']}}>{state['CURRENT_ROOM']}</td>
</tr>
);
}
