...
export const getLsClientAsync = createAsyncThunk(
  "todos/getLsClientAsync",
...
const todoSlice = createSlice({
  ...
  reducers: {
    ...
    UpdateListStock: (state, action) => {
      const index = state.LIST_STOCK.findIndex(
      ...
      if (index >= 0) {
        ...
        state.LIST_STOCK[index].BUY_FOREIGN_QTTY =
          action.payload.BUY_FOREIGN_QTTY;
        state.LIST_STOCK[index].CEILING_PRICE = action.payload.CEILING_PRICE;
        state.LIST_STOCK[index].CEILING_PRICE_W =
          action.payload.CEILING_PRICE_W;
        ...
        state.LIST_STOCK[index].LAST_TRADING_DATE =
          action.payload.LAST_TRADING_DATE;
        ...
        state.LIST_STOCK[index].SELL_FOREIGN_QTTY =
          action.payload.SELL_FOREIGN_QTTY;
        ...
        state.LIST_STOCK[index].TOTAL_TRADED_QTTY =
          action.payload.TOTAL_TRADED_QTTY;
        state.LIST_STOCK[index].TOTAL_TRADED_VALUE =
          action.payload.TOTAL_TRADED_VALUE;
      } else {
        //insert
...
export const { getClientConnect, UpdateListStock, SortbyName } =
  todoSlice.actions;
